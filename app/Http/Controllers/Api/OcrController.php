...
class OcrController extends Controller
{
    ...
    public function storeFieldMapping(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'fields.*.extraction_mode' => 'nullable|string|in:auto,same_line,next_line,prev_line,mrz',
            'fields.*.transform'   => 'nullable|array',
            'fields.*.transform.*' => 'string|in:remove_spaces,uppercase,lowercase,trim,digits_only,alphanumeric,normalize_gender,normalize_nationality',
            'fields.*.format'      => 'nullable|string|max:100',
            'fields.*.value_map'   => 'nullable|array',
            'fields.*.value_map.*' => 'string|max:255',
